...
#ifndef SAVE_IN_BB__HPP
#define SAVE_IN_BB__HPP
...
class SaveDetectionInBB : public BT::ActionNodeBase
{
public:
  explicit SaveDetectionInBB(const std::string & xml_tag_name, const BT::NodeConfiguration & conf);
